 <?php
    ...
    $stmt = $pdo->prepare("
        SELECT c.nom 
        FROM clubs c
        INNER JOIN membre_club m ON c.id = m.club_id
    ...
    $stmt = $pdo->prepare("
        SELECT e.nom 
        FROM evenements e
        INNER JOIN membre_evenement m ON e.id = m.evenement_id
        WHERE m.membre_id = :user_id
    ");
    $stmt->execute(['user_id' => $_SESSION['user_id']]);
                                    ...
                                    <div class="content">
                                        ...
                                        <ul class="profile-info">
                                            <?php foreach ($clubs as $club): ?>
                                                <li><span><p><?php echo htmlspecialchars($club); ?></p></span></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                                </section>
                                    ...
                                    <div class="content">
                                        ...
                                        <ul class="profile-info">
                                            <?php foreach ($events as $event): ?>
                                                <li><span><p><?php echo htmlspecialchars($event); ?></p></span></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                                </section>
